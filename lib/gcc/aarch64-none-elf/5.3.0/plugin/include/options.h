...
enum opt_code
{
  ...
  OPT_mcmodel_ = 1139,                       /* -mcmodel= */
  OPT_mcpu_ = 1140,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1141,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1142,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1143,             /* -mgeneral-regs-only */
  OPT_mlittle_endian = 1144,                 /* -mlittle-endian */
  OPT_momit_leaf_frame_pointer = 1145,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1146,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1147,                  /* -mtls-dialect= */
  OPT_mtune_ = 1148,                         /* -mtune= */
  OPT_n = 1149,                              /* -n */
  OPT_no_canonical_prefixes = 1150,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1151,              /* -no-integrated-cpp */
  OPT_nocpp = 1152,                          /* -nocpp */
  OPT_nodefaultlibs = 1153,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1154,                   /* -nostartfiles */
  OPT_nostdinc = 1155,                       /* -nostdinc */
  OPT_nostdinc__ = 1156,                     /* -nostdinc++ */
  OPT_nostdlib = 1157,                       /* -nostdlib */
  OPT_o = 1158,                              /* -o */
  OPT_p = 1159,                              /* -p */
  OPT_pass_exit_codes = 1160,                /* -pass-exit-codes */
  /* OPT_pedantic = 1161, */                 /* -pedantic */
  OPT_pedantic_errors = 1162,                /* -pedantic-errors */
  OPT_pg = 1163,                             /* -pg */
  OPT_pie = 1164,                            /* -pie */
  OPT_pipe = 1165,                           /* -pipe */
  OPT_print_file_name_ = 1166,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1167,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1168,          /* -print-multi-directory */
  OPT_print_multi_lib = 1169,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1170,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1171,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1172,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1173,               /* -print-prog-name= */
  OPT_print_search_dirs = 1174,              /* -print-search-dirs */
  OPT_print_sysroot = 1175,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1176,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1177,                          /* -quiet */
  OPT_r = 1178,                              /* -r */
  OPT_remap = 1179,                          /* -remap */
  OPT_s = 1180,                              /* -s */
  OPT_s_bc_abi = 1181,                       /* -s-bc-abi */
  OPT_save_temps = 1182,                     /* -save-temps */
  OPT_save_temps_ = 1183,                    /* -save-temps= */
  OPT_shared = 1184,                         /* -shared */
  OPT_shared_libgcc = 1185,                  /* -shared-libgcc */
  /* OPT_specs = 1186, */                    /* -specs */
  OPT_specs_ = 1187,                         /* -specs= */
  OPT_static = 1188,                         /* -static */
  OPT_static_libasan = 1189,                 /* -static-libasan */
  OPT_static_libgcc = 1190,                  /* -static-libgcc */
  OPT_static_libgcj = 1191,                  /* -static-libgcj */
  OPT_static_libgfortran = 1192,             /* -static-libgfortran */
  OPT_static_libgo = 1193,                   /* -static-libgo */
  OPT_static_liblsan = 1194,                 /* -static-liblsan */
  OPT_static_libmpx = 1195,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1196,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1197,               /* -static-libstdc++ */
  OPT_static_libtsan = 1198,                 /* -static-libtsan */
  OPT_static_libubsan = 1199,                /* -static-libubsan */
  /* OPT_std_c__03 = 1200, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1201, */                /* -std=c++0x */
  OPT_std_c__11 = 1202,                      /* -std=c++11 */
  OPT_std_c__14 = 1203,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1204, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1205, */                /* -std=c++1y */
  OPT_std_c__1z = 1206,                      /* -std=c++1z */
  ...
  OPT_std_gnu__14 = 1222,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1223, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1224, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1225,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1226,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1227,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1228, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1229, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1230,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1231,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1232, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1233, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1234,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1235, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1236, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1237, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1238,                     /* -std=legacy */
  OPT_symbolic = 1239,                       /* -symbolic */
  OPT_t = 1240,                              /* -t */
  OPT_time = 1241,                           /* -time */
  OPT_time_ = 1242,                          /* -time= */
  OPT_traditional = 1243,                    /* -traditional */
  OPT_traditional_cpp = 1244,                /* -traditional-cpp */
  OPT_trigraphs = 1245,                      /* -trigraphs */
  OPT_u = 1246,                              /* -u */
  OPT_undef = 1247,                          /* -undef */
  OPT_v = 1248,                              /* -v */
  OPT_version = 1249,                        /* -version */
  OPT_w = 1250,                              /* -w */
  OPT_wrapper = 1251,                        /* -wrapper */
  OPT_x = 1252,                              /* -x */
  OPT_z = 1253,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
